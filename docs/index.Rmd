...
* A **`README.md`** file that describes the lesson's objectives, `R` packages it requires, and provides links to additional resources.
...
* A **challenge** for students to complete after the lesson if they want to practice, and a corresponding set of replication code for students to check their own work.
